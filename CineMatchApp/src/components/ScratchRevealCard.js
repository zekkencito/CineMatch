...
const ScratchRevealCard = ({ 
  ...
  // Debug logs
  useEffect(() => {
    console.log('ScratchRevealCard renderizado:', {
      movie: movie?.title,
      isVisible,
      isRevealed,
      scratchProgress
    });
  }, [movie, isVisible, isRevealed, scratchProgress]);

  const handleReveal = () => {
    console.log('Iniciando revelación de película');
    setIsRevealed(true);
    
    // Animación de desvanecimiento de la capa de scratch
    Animated.parallel([
  ...
  const handleGestureStateChange = (event) => {
    if (event.nativeEvent.state === State.END) {
      ...
      console.log('Gesto terminado, progreso final:', scratchProgress);
    }
  };
  ...
  if (!movie) {
    console.log('ScratchRevealCard: No hay película para mostrar');
    return null;
  }
          ...
          <View style={styles.cardContainer}>
            ...
            {!isRevealed && (
              ...
              >
                ...
                >
                  <Animated.View style={styles.scratchTouchable}>
                    <LinearGradient
